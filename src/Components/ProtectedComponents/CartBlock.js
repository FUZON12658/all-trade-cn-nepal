...
const CartBlock = (props) => {
  ...
  const handleProceedToCheckout = () => {
    ...
    userActions.setProductPrice(productPrice);
 ...
 ///work pending from here
  ...
  return (
      ...
      <div className="informationOfProduct">
        ...
        value={cartQuantity} disabled={!updateCart} onChange={handleQuantityChange} /></div>
        ...
        <button className="proceedToCheckoutBtn" onClick={handleProceedToCheckout}>Proceed To Checkout</button>
        {updateCart && <button className="editCartQuantityBtn proceedToCheckoutBtn" onClick={handleDoneClick}>Done</button>}
        </div>
      </div>
      <div className="interactiveButtons">
      <div className="editCart" onClick={handleEditClick}>
        <i className="fa-solid fa-pen-to-square"></i>
      </div>
      <div className="deleteCart" onClick={deleteFromCart}>
